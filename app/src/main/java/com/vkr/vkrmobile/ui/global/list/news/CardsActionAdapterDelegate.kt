...
import kotlinx.android.synthetic.main.action_card_item.view.*

class CardsActionAdapterDelegate() : AdapterDelegate<MutableList<NewsResponse>>() {

    override fun onCreateViewHolder(parent: ViewGroup): RecyclerView.ViewHolder {
        return ViewHolder(parent.inflate(R.layout.action_card_item))
    }
